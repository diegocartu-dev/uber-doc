...
| **La reprogramación no movía el reparto** | `reprogramada` valía 0 en el contador de equidad: el que recibía ocho pacientes seguía primero en la fila y el que no atendió a nadie bajaba de prioridad. Y un profesional con el acuerdo completo podía recibir cinco turnos por reprogramación | `deltaDeAsignacion()` (+1 al que recibe, fila `cancelada` para el que pierde), guard R6 en la reprogramación y cupo acumulado en el plan. **⚠ Revertido en la Etapa 8** (decisión de Diego, 13/08 — R6 flexible): el guard de la reprogramación se eliminó y el cupo dejó de ser un tope. El acuerdo es el piso de servicio comprometido, no un techo: mientras el profesional tenga un turno publicado, ese turno se puede tomar. Lo que sigue en pie de este hallazgo es el reparto (`deltaDeAsignacion`), que es lo que ordena la oferta |
