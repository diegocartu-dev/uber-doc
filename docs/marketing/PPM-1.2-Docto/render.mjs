// Renderiza las capturas ficticias y la pieza 1080×1920 (PPM 1.2 — simplicidad).
// Uso: node docs/marketing/PPM-1.2-Docto/render.mjs
...
await shot({
  file: "capturas/captura-paciente-listo.html",
  out: "capturas/captura-paciente-listo.png",
  viewport: { width: 450, height: 900 },
  scale: 3,
  selector: "#frame",
});
...
await shot({
  ...
  out: "PPM 1.2 Docto.png",
  viewport: { width: 1080, height: 1920 },
  scale: 2,
  fullViewport: true,
});

// Versión PDF — vectorial (no pixela) y con el botón docto.com.ar/medicos como
// LINK clickeable de verdad. Ideal para mandar por WhatsApp como documento.
...
await pdf("template-1080x1920.html", "PPM 1.2 Docto.pdf");
