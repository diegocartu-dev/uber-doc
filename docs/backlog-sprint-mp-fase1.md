...
## 4. Mensaje UX confuso para token_exchange_failed

- **Archivo:** `src/app/medico/perfil/PerfilClient.tsx` (línea 63)
- **Problema:** Cuando el token exchange falla, el toast muestra "Mercado Pago rechazó la conexión" — confuso porque no siempre es MP quien rechaza
