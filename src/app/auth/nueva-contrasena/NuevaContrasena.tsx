...
export default function NuevaContrasena() {
  ...
  const inputClass =
    "mt-1 block w-full rounded-[var(--radius-md)] border px-3 pr-11 text-[15px] shadow-sm focus:outline-none";
      ...
      <div className="w-full max-w-sm">
        ...
        {listo ? (
          <div className="rounded-xl bg-white p-6 text-center" style={{ border: "1px solid #e5e7eb" }}>
            <CheckCircle size={40} className="mx-auto mb-3" style={{ color: "#1D9E75" }} />
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div>
                <label htmlFor="confirmar" className="block text-[13px] font-medium" style={{ color: "var(--color-text-secondary)" }}>
