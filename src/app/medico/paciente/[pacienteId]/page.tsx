...
export default async function FichaPacientePage({
  ...
  // Perfil médico-paciente (patología crónica)
  ...
  return (
    <div className="min-h-full bg-[#f8f9fa]">
      ...
      <main className="mx-auto max-w-3xl px-6 py-8">
        ...
        {/* Historia Clínica — consultas completadas */}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-5 space-y-4" style={{ lineHeight: "1.7" }}>
                      {(c as { evolucion?: string | null }).evolucion && (
                        <div>
                          <p className="text-xs font-semibold tracking-wide text-gray-400 uppercase">Evolución</p>
                          <p className="mt-1 text-sm text-gray-800 whitespace-pre-line">{(c as { evolucion?: string | null }).evolucion}</p>
                        </div>
                      )}
