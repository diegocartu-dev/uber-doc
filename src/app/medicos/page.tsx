...
export default async function MedicosLanding() {
  ...
  return (
    <div className="medicos-root" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#fff", overflowX: "hidden" }}>
      {/* Nav */}
      <nav style={{
        position: "sticky",
        top: 0,
        ...
        <div style={{
          ...
          <div className="medicos-nav-links" style={{ display: "flex", alignItems: "center", gap: 24 }}>
            <Link href="/pacientes" className="medicos-nav-pacientes" style={{ fontSize: 14, color: "var(--color-text-secondary)", fontWeight: 500 }}>
              ¿Buscás un médico?
            </Link>
            <Link
      ...
      <section style={{ padding: "80px 24px", background: "var(--color-bg-secondary)" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <div className="medicos-formas-grid" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          <div style={{
            ...
            <ShieldCheck size={15} style={{ color: "var(--color-text-tertiary)" }} />
            Plataforma inscripta ante la AAIP (RL-2026-36086505).
            Opera bajo Ley 27.553 y Decreto 63/2024.
          </div>
        </div>
      </section>
      ...
      <style>{`
        @media (max-width: 560px) {
          .medicos-nav-pacientes { display: none !important; }
          .medicos-nav-links { gap: 12px !important; }
        }
      `}</style>
    </div>
  );
