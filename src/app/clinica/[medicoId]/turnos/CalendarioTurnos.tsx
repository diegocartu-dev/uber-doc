  ...
  if (exito) {
    return (
      <div className="mt-8 text-center">
        ...
        <a href="/dashboard" className="mt-6 inline-block rounded-lg bg-[#7BAFD4] px-6 py-2.5 text-sm font-medium text-white">
          Volver al inicio
        </a>
      </div>
    );
        ...
        <div className="mt-4 rounded-xl bg-white p-5" style={{ border: "0.5px solid #e5e7eb" }}>
          ...
          <div className="mt-5 flex gap-3">
            ...
            <button
              ...
              className="flex-1 rounded-lg bg-[#7BAFD4] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#6A9FC4] active:scale-95 transition-all duration-100"
            >
              Confirmar turno →
            </button>
          </div>
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <LoadingButton
                ...
                isLoading={isPending}
                className="flex-1 rounded-lg bg-[#7BAFD4] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#6A9FC4] disabled:opacity-50 active:scale-95 transition-all duration-100"
              >
                Confirmar y pagar
              </LoadingButton>
            </div>
