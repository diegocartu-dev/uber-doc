export default function PrivacidadContent() {
  return (
    <article className="prose prose-sm prose-gray max-w-none">
      ...
      <p>Diego Oscar González, CUIT 20-25086458-3, con domicilio en Olga Cossettini 1540, Piso 6, Of. 601, Puerto Madero, Ciudad Autónoma de Buenos Aires, Argentina. Contacto: soporte@docto.com.ar.</p>
      <p>Docto se encuentra inscripta ante la Agencia de Acceso a la Información Pública (AAIP) como responsable de una base de datos de carácter personal bajo el legajo RL-2026-36086505-APN-DNPDP#AAIP (base de datos registrada: RL-2026-41929595-APN-DNPDP#AAIP).</p>
