...
- **Camino al lanzamiento real:** `docs/CAMINO_A_LANZAMIENTO_V1.md`. Lo único que falta de verdad para cobrar = la **prueba real de pagos** (par whitelisteado paancogliando/pbuenoloco). Después: abrir el registro (sacar rutas de `BETA_PROTECTED`) + habilitar cobro real general.
